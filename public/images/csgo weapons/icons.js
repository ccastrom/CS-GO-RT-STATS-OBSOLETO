...
document.getElementById("mapImage").src=icons[mapName];
document.getElementById("imgMapHistory").src=icons[mapName];
//90*30

//Rifles
document.getElementById("akImage").src=icons.ak47;
document.getElementById("m4Image").src=icons.m4a1;
document.getElementById("augImage").src=icons.aug;
document.getElementById("awpImage").src=icons.awp;
document.getElementById("famasImage").src=icons.famas;
//-----------------------------------------------------
//submachineguns
document.getElementById("p90Image").src=icons.p90;
document.getElementById("mp7Image").src=icons.mp7;
document.getElementById("bizonImage").src=icons.bizon;
document.getElementById("macImage").src=icons.mac10;
document.getElementById("umpImage").src=icons.ump45;
//-----------------------------------------------------
//heavyGuns
document.getElementById("negevImage").src=icons.negev;
document.getElementById("novaImage").src=icons.nova;
document.getElementById("xm1014Image").src=icons.xm1014;
document.getElementById("m249Image").src=icons.m249;
document.getElementById("magImage").src=icons.mag7;
//-----------------------------------------------------
//Pistols
document.getElementById("p2000Image").src=icons. hkp2000;
document.getElementById("glockImage").src=icons.glock;
